...
import com.tyron.code.desktop.util.CollectionUtil;
...
public class SyntaxUtil {
	 ...
	 */
	public static IntRange getRangeForRestyle(@NotNull String text,
											  @NotNull StyleSpans<Collection<String>> styleSpans,
											  @Nullable SyntaxHighlighter syntaxHighlighter,
											  @NotNull PlainTextChange change) {
	...
	private static class StyledRange {
		 ...
		 * 		Span style classes.
		 */
		public StyledRange(@NotNull IntRange range, @NotNull Collection<String> style) {
			this.range = range;
			this.style = style;
		}
		 ...
		 */
		public boolean canMergeInto(@NotNull StyledRange other) {
		 ...
		 */
		public void merge(@NotNull StyledRange other) {
