package com.tyron.code.desktop.ui.control.richtext.search;

import atlantafx.base.controls.CustomTextField;
import atlantafx.base.controls.Popover;
import atlantafx.base.controls.Spacer;
import atlantafx.base.theme.Styles;
import com.tyron.code.desktop.ui.control.ActionButton;
import com.tyron.code.desktop.ui.control.ActionMenuItem;
import com.tyron.code.desktop.ui.control.BoundToggleIcon;
...
import com.tyron.code.desktop.util.*;
...
//        }
    ...
    private static class Bar extends VBox {
        ...
        private Bar(@NotNull Editor editor) {
            this.editor = editor;
            ...
            BoundToggleIcon toggleSensitivity = new BoundToggleIcon(new FontIconView(CarbonIcons.SWITCHER), caseSensitivity).withTooltip("misc.casesensitive");
            BoundToggleIcon toggleRegex = new BoundToggleIcon(new FontIconView(CarbonIcons.SETTINGS_CHECK), regex).withTooltip("misc.regex");
         ...
         *
         * @param index Index in {@link #resultRanges} to replace.
         */
        ...
        private void hide() {
            ...
            FxThreadUtils.delayedRun(1, () -> editor.getCodeArea().requestFocus());
        }
    ...
    /**
     * @param range  Range of the match.
     * @param groups Regex groups of the match, if the match is done with {@link Bar#regex} enabled.
     */
    private record Match(@NotNull IntRange range, @Nullable String[] groups) implements Comparable<Match> {
        @NotNull
        ...
        @NotNull
        static Match match(int start, int end, @NotNull Matcher matcher) {
