...
public class DockingRegionFactory extends DetachableTabPaneFactory {
    ...
    /**
     * @param manager Associated docking manager.
     */
    public DockingRegionFactory(@NotNull DockingManager manager) {
    ...
    protected void init(DetachableTabPane newTabPane) {
        newTabPane.setSceneFactory(param -> new Scene(param, SCENE_WIDTH, SCENE_HEIGHT));
