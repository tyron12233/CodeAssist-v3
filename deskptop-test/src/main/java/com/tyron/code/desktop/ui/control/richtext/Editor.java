...
//	private ProblemOverlay problemOverlay;
     ...
     *
     * @param position Start position to begin the restyling at.
     * @param length   Length of the restyled range.
    ...
    /**
     * @param syntaxHighlighter Highlighter to use.
     */
    ...
    /**
     * @param selectedBracketTracking New selected bracket tracking implementation, or {@code null} to disable selected bracket tracking.
     */
    ...
    /**
     * @param problemTracking Problem tracking implementation.
     */
...
//			problemOverlay.install(this);
    ...
    /**
     * @param supplierService Executor service to run the supplier on.
     * @param supplier        Value supplier.
     * @param consumer        Value consumer, run on the JavaFX UI thread.
     * @param <T>             Value type.
