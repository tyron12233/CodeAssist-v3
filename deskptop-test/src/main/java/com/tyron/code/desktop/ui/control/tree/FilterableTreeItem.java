...
public class FilterableTreeItem<T> extends TreeItem<T> {
	 ...
	 * 		Match status.
	 */
	protected void onMatchResult(@NotNull TreeItem<T> child, boolean matched) {
	...
	private void setUnderlyingChildren(@NotNull ObservableList<TreeItem<T>> list) {
	...
	public void addAndSortChild(@NotNull TreeItem<T> item) {
	 ...
	 * 		Child item to add.
	 */
	protected void addPreSortedChild(@NotNull TreeItem<T> item) {
		sourceChildren.add(item);
	}
	 ...
	 */
	public boolean removeSourceChild(@NotNull TreeItem<T> child) {
		synchronized (sourceChildren) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <I extends TreeItem<T>> void sortChildren(@NotNull Comparator<I> comparator) {
		synchronized (sourceChildren) {
