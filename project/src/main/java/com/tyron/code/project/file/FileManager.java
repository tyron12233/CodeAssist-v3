...
public interface FileManager {
     ...
     *     from the beginning of {@code editRange} will be replaced. If it's longer than the actual range
     ...
     */
    void setSnapshotContent(URI fileUri, String newText);
     ...
     *
     * <p>All snapshot files opened by {@link #openFileForSnapshot} will be closed.
     */
    void shutdown();
